...
def user_time():
    ...
    # if user said yes they will be transferred into the timer def
    if time_user == "yes" or time_user == "y":
        timer()
    # while if the user pressed no, they will be transferred into
    # the main def where they can repeat the quiz over again
...
def play_again():
    ...
    if play == "yes" or play == "y":
        print("Welcome back to the quiz ", name_user)
        user_time()
    elif play == "no" or play == "n":
        print("------------------------------")
        print("Thank you for playing the quiz ", name_user)
        print("------------------------------")
        exit(0)
    else:
        print("Please choose one of the option?")
...
def timer():
    def countdown():
        ...
        replay = yes_no("Do you wish to play the quiz again?")
    ...
    while my_timer > 0:
        ...
        print(meaning)
        user_question = input(questions['question2'])
        for user_question in list_of_option:
            if user_question not in list_of_option:
                print("Please choose one of the option")
            elif user_question == answer['answer2']:
                num_of_scores += 1
